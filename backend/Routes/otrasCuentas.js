...
const {recuperarUsuarios, restablecerCuenta, activarDesactivarCuenta, cambiarPermisosCuenta, recuperarEstado, recuperarPermisos} = require('../Controllers/otrasCuentas.controller');

// GET para recuperar todos los usuarios
router.get('/usuarios', recuperarUsuarios);

// GET para recuperar todos los permisos
router.get('/usuarios', recuperarEstado);
...
// PUT para activar o desactivar una cuenta
router.put('/usuarios/:legajo/estado', activarDesactivarCuenta);
