...
router.get('/estadisticas', (req, res) => {
  ...
  db.query(query, [dias], (err, results) => {
    ...
    logSeguridad('Consulta estadísticas sin filtros', 'GET', req.query.usuario || 'Sistema');
    res.json(results);
  });
});
...
router.get('/estadisticas_filtros', (req, res) => {
  ...
  db.query(query, valores, (err, results) => {
    ...
    logSeguridad('Consulta estadísticas con filtros', 'GET', req.query.usuario || 'Sistema');
    res.json(results);
  });
});
